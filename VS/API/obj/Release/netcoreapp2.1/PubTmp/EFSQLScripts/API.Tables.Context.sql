...
BEGIN
    ...
    VALUES (N'20180917125726_initialCreate', N'2.1.4-rtm-31024');
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20180917135017_m001', N'2.1.4-rtm-31024');
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20180927171625_m002', N'2.1.4-rtm-31024');
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20180927171625_m02', N'2.1.4-rtm-31024');
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20181002115004_m004', N'2.1.4-rtm-31024');
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20181002115824_m005', N'2.1.4-rtm-31024');
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20181002120117_m006', N'2.1.4-rtm-31024');
END;

GO

IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20181005134711_m007')
BEGIN
    DECLARE @var11 sysname;
    SELECT @var11 = [d].[name]
    FROM [sys].[default_constraints] [d]
    INNER JOIN [sys].[columns] [c] ON [d].[parent_column_id] = [c].[column_id] AND [d].[parent_object_id] = [c].[object_id]
    WHERE ([d].[parent_object_id] = OBJECT_ID(N'[PP_Project]') AND [c].[name] = N'DateAdded');
    IF @var11 IS NOT NULL EXEC(N'ALTER TABLE [PP_Project] DROP CONSTRAINT [' + @var11 + '];');
    ALTER TABLE [PP_Project] DROP COLUMN [DateAdded];
END;
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20181005134711_m007')
BEGIN
    ALTER TABLE [PP_Project] ADD [GroupName] nvarchar(max) NULL;
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20181005134711_m007', N'2.1.4-rtm-31024');
END;

GO

IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20181005143241_m008')
BEGIN
    EXEC sp_rename N'[PP_Project].[ProjectCategory]', N'ProjectCategoryID', N'COLUMN';
END;
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20181005143241_m008')
BEGIN
    EXEC sp_rename N'[PP_Project].[CustomerMapCode]', N'CustomerMapCodeID', N'COLUMN';
END;
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20181005143241_m008')
BEGIN
    EXEC sp_rename N'[PP_Project].[CustomerCentricScore]', N'CustomerCentricScoreID', N'COLUMN';
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20181005143241_m008', N'2.1.4-rtm-31024');
END;

...
namespace API.Controllers
{
  ...
  public class CategoriesController : Controller
  {
    ...
    [HttpGet("{id}")]
    public async Task<IActionResult> GetPP_Category([FromRoute] int id)
    {
    ...
    [HttpPut("{id}")]
    public async Task<IActionResult> PutPP_Category([FromRoute] int id, [FromBody] PP_Category pP_Category)
    {
      if (!ModelState.IsValid)
      {
        return BadRequest(ModelState);
    ...
    [HttpDelete("{id}")]
    public async Task<IActionResult> DeletePP_Category([FromRoute] int id)
    {
      if (!ModelState.IsValid)
      {
        return BadRequest(ModelState);
    ...
    private bool PP_CategoryExists(int id)
    {

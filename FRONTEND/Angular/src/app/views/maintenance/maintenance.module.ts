...
@NgModule({
  ...
  declarations: [
    ...
    ProjectcategoryAddeditComponent,
    CustomerMapcodeListComponent,
    CustomerMapcodeAddeditComponent,
    CustomerMapcodeDeleteComponent,
    CustomerCentricscoreListComponent,
    CustomerCentricscoreAddeditComponent,
    CustomerCentricscoreDeleteComponent,
    ContactsListComponent,
    ContactsAddeditComponent,
    ContactsDeleteComponent,
    ProjectcategoryDeleteComponent
  ]
})
